/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b2ef14da0209cca927a1b7705f1837a0)
// Runtime types generated with workerd@1.20260526.1 2026-04-05 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: string;
	INTERNAL_TOKEN: string;
	BEST_BUY_API_KEY: string;
	API_WORKER: Fetcher /* purdue-photography-club-api */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "INTERNAL_TOKEN" | "BEST_BUY_API_KEY">> {}
}
